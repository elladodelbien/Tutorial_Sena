...
const Section = ({ titulo, bg }) => {
  ...
  return (
    <>
      ...
      >
        <motion.div className="flex   flex-col md:mb-48 p-4 backdrop-blur-sm md:backdrop-blur-md  items-center">
          <motion.h1 className="md:text-4xl text-3xl   text-white font-bold ">
            Bienvenido
          </motion.h1>

          {/* Aqui el contenido de la seccion */}
          <motion.p className="md:text-xl text-white  text-lg font-bold text-center ">
